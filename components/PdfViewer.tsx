...
//
// app/publication/PdfViewer.tsx is NOT the same component: it takes an
// optional per-publication `flipbookUrl` and embeds that when present,
// otherwise it falls back to the same gdocs-viewer approach used here. (It
// used to ignore `url` entirely and render one hardcoded Heyzine link, which
// made every old issue open the latest one — fixed.)
//
